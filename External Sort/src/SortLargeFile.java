...
public static final int MAX_ARRAY_SIZE = 100000;
    ...
    {
        //sort largedata.dat to sortfile.dat
    ...
    private static void merge(int numberOfSegments, int segmentSize, String f1, String f2, String f3, String targetfile) throws IOException
    {
     ...
     */
    private static void copyHalfToF2(int numberOfSegments, int segmentSize, DataInputStream f1, DataOutputStream f2) throws IOException
    {
     ...
     * merge all segments
     */
    public static void mergeSegments(int numberOfSegments, int segmentSize, DataInputStream f1, DataInputStream f2, DataOutputStream f3) throws IOException
    {
     ...
     * merge two segments
     */
    public static void mergeTwoSegments(int segmentSize, DataInputStream f1, DataInputStream f2, DataOutputStream f3) throws IOException
    {
    ...
    public static void displayFile(String fileName)
    {
        try
        {
            DataInputStream input = new DataInputStream(new BufferedInputStream(new FileInputStream(fileName), BUFFER_SIZE));
